(function() {
     ...
     *
     * @param {Array}  filesToScrape  a list of files to srape for documentation
     * @param {Object} options  user overrides
     */
    var StyleGuideGenerator = function(filesToScrape, options) {
        /**
         * Files to scrape for component documentation
         *
         * @property styleGuideGenerator.filesToScrape
         * @type {Array}
         */
        this.filesToScrape = filesToScrape || [];
    ...
    proto.build = function() {
        return expand(this.filesToScrape).then(function(expandedFiles) {
