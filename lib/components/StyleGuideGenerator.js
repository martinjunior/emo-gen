(function() {
    ...
    proto.init = function() {
        ...
        nunjucks.configure(path.join(path.resolve(this.options.path.src), path.sep), {
            autoescape: false
        });
    };
     ...
     */
    proto.build = function(componentFiles, viewDir, componentData) {
        return this.scrape(componentFiles).then(function() {
            ...
            return this.componentsCollection.load(componentData);
        }.bind(this)).then(function() {
