(function() {
    ...
    var StyleGuide = function(filesToScrape, filesToCopy, options) {
    ...
    proto.build = function() {
        return this.place().then(function() {
            return this.copyFiles(this.filesToCopy);
        }.bind(this)).then(function() {
            return expandFiles(this.filesToScrape);
        }.bind(this)).then(function(expandedFiles) {
